 ...
 * @author invitado
 */
public class EmpleadoA extends javax.swing.JInternalFrame {
    private Controladora miControl;
    /**
     * Creates new form EmpleadoA
     */
    public EmpleadoA(Controladora c) {
        miControl = c;
        initComponents();
    ...
    private void initComponents() {
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Administrativo" }));
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Jefe de RH", "Analista de RH", "Jefe de Compras", "Analista de Compras", "Jefe Financiero", "Analista Financiero", "Jefe de Ventas", "Analista de Ventas" }));
